  ...
  return (
    <section className="py-16 lg:py-[90px] relative z-10">
      <div className="max-w-[640px] mx-auto px-6 text-center">
        ...
        <a
          href={`https://wa.me/VOTRE_NUMERO?text=${encodeURIComponent(t.beta_wa_msg)}`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 h-14 px-8 rounded-[14px] bg-primary text-[#062b15] font-bold text-[17px] transition-transform duration-150 hover:-translate-y-0.5 shadow-[0_0_24px_rgba(37,211,102,0.3)]"
        >
